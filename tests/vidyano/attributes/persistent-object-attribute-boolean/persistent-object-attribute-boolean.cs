    ...
    .WithModel(builder =>
        {
            ...
            var booleanReadOnly = po.GetOrCreateAttribute(nameof(Mock_Attribute.BooleanReadOnly));
            booleanReadOnly.IsReadOnly = true;

            var booleanCheckboxReadOnly = po.GetOrCreateAttribute(nameof(Mock_Attribute.BooleanCheckboxReadOnly));
            booleanCheckboxReadOnly.DataTypeHints = "inputtype=checkbox";
            booleanCheckboxReadOnly.IsReadOnly = true;

            var booleanRequired = po.GetOrCreateAttribute(nameof(Mock_Attribute.BooleanRequired));
            booleanRequired.AddRule("Required");
        })
    );
