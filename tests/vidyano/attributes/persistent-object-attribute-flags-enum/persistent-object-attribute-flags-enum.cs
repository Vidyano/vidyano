    ...
    .WithModel(builder =>
        {
            ...
            var flagsEnumReadOnly = po.GetOrCreateAttribute(nameof(Mock_Attribute.FlagsEnumReadOnly));
            flagsEnumReadOnly.IsReadOnly = true;
        })
    );
...
public enum NotificationOptions
{
    ...
    InApp        = 8,
    WeeklyDigest = 16,
    All = Email | SMS | Push | InApp | WeeklyDigest
}
...
public class Mock_Attribute
{
    ...
    public NotificationOptions FlagsEnum { get; set; } = NotificationOptions.Email;

    public NotificationOptions FlagsEnumMultiple { get; set; } = NotificationOptions.Email | NotificationOptions.SMS | NotificationOptions.Push;

    public NotificationOptions FlagsEnumNone { get; set; } = NotificationOptions.None;

    public NotificationOptions FlagsEnumReadOnly { get; set; } = NotificationOptions.InApp;
}
