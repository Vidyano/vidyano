    ...
    .WithModel(builder =>
        {
            ...
            var readOnly = po.GetOrCreateAttribute(nameof(Mock_Attribute.NullableBooleanReadOnly));
            readOnly.IsReadOnly = true;

            // Configure Required variant
            var required = po.GetOrCreateAttribute(nameof(Mock_Attribute.NullableBooleanRequired));
...
public class Mock_Attribute
{
    ...
    [DataType(DataTypes.NullableBoolean)]
    public bool? NullableBoolean { get; set; } = null;

    [DataType(DataTypes.NullableBoolean)]
    public bool? NullableBooleanWithValue { get; set; } = true;

    [DataType(DataTypes.NullableBoolean)]
    public bool? NullableBooleanReadOnly { get; set; } = true;

    [DataType(DataTypes.NullableBoolean)]
    public bool? NullableBooleanRequired { get; set; } = false;
}
