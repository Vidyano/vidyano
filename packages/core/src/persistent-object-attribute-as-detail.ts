import { createObservableArray } from "./observable/index.js"
...
export class PersistentObjectAttributeAsDetail extends PersistentObjectAttribute {
    ...
    #createObservableArray(array: PersistentObject[]): PersistentObject[] {
        return createObservableArray(array, (index, removed, added) => {
            this.notifyArrayChanged("objects", index, removed, added);
        });
    }
