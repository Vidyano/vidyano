...
public partial class KeyValueListActions : DefaultPersistentObjectActions<VidyanoWeb3Context, KeyValueListActions.KeyValueList>
{
    public KeyValueListActions(VidyanoWeb3Context context)
        : base(context)
    {
    }
