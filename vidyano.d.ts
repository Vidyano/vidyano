...
declare class PathRoute {
    ...
    to(fn: Function): this;
    enter(fns: Function | Function[]): this;
    exit(fns: Function | Function[]): this;
    partition(): any[];
    run(): void;
}
declare class PathHistory {
    initial: {
        popped: boolean;
        URL: string;
    };
    noHistory: boolean;
    pushState(state: any, title: any, path: any): void;
    replaceState(state: any, title: string, path: string): void;
    popState(): void;
    listen(): void;
}
declare class Path {
    static readonly routes: PathRoutes;
    static readonly history: PathHistory;
    private static readonly _splitRegex;
    static map(path: any): PathRoute;
    static root(path: string): void;
    static rescue(fn: Function): void;
    static match(path: string, parameterize: boolean): any;
    static dispatch(passed_route: string): boolean;
}
...
declare class QueryColumn extends ServiceObject {
     ...
     */
    constructor(service: Service, col: QueryColumn$1 | any, query: Query$1);
    /** Gets the column id. */
    get id(): string;
...
declare class QueryFilters extends Observable<QueryFilters> {
     ...
     */
    constructor(query: Query$1, filtersPO: PersistentObject$1);
    /**
...
declare class QueryChart extends Observable<QueryChart> {
     ...
     */
    constructor(query: Query$1, label: string, name: string, options: any, type: string);
    /**
...
declare class QueryResultItemGroup extends Observable<QueryResultItemGroup> implements QueryResultItemGroup$1 {
     ...
     */
    constructor(query: Query$1, group: QueryResultItemGroup$1, start: number, end: number, notifier: () => void);
    /**
     * Gets the group name.
     */
    get name(): string;
...
declare class QueryResultItem extends ServiceObject {
     ...
     */
    constructor(service: Service, item: QueryResultItem$1, query: Query$1, isSelected: boolean);
    /**
...
declare class ExecuteActionArgs {
     ...
     */
    constructor(service: Service, action: string, persistentObject: PersistentObject$1, query: Query$1, selectedItems: QueryResultItem[], parameters: any);
    /**
...
declare class Service extends Observable<Service> {
     ...
     */
    getQuery(id: string, optionsOrAsLookup?: boolean | GetQueryOptions, parent?: PersistentObject$1, textSearch?: string, sortOptions?: string): Promise<Query$1>;
    /**
...
type vidyano_CookieGetOptions = CookieGetOptions;
type vidyano_CookieSetOptions = CookieSetOptions;
...
type vidyano_GetQueryOptions = GetQueryOptions;
...
type vidyano_IQueueAddOptions = IQueueAddOptions;
...
type polymer_IronListElement = IronListElement;
