...
{
    public class PersistentObjectActionsReference<TContext, TEntity> : PersistentObjectActionsReference<TContext, TEntity, TEntity>
    ...
    public class PersistentObjectActionsReference<TContext, TEntity, TQueryEntity> : PersistentObjectActions<TContext, TEntity, TQueryEntity>
        where TContext : ITargetContext
        where TEntity : class
        where TQueryEntity : class
    {
        ...
        protected override void SaveExisting(PersistentObject obj, TEntity entity)
        {
            ...
            {
                if (IsValueObject) // NOTE: Parent is responsible for saving the aggregate root
                    return;
