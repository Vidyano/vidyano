...
public partial class Feature_RetryAction : CustomAction<DevContext>
{
    public override PersistentObject? Execute(CustomActionArgs e)
    {
        ...
        if (Manager.Current.RetryResult == null)
            Manager.Current.RetryAction("Are you sure?", "Fill in the form below:", Manager.Current.GetPersistentObject(nameof(Feature_RetryAction), isNew: true, targetContext: Context), options, 0, 1);
